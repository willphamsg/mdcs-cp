...
@Component({
  selector: 'app-export-cancel-download-dialog',
  standalone: true,
  imports: [MatDialogModule, MatButtonModule],
  template: `
    <div class="dialog-container">
      <h2 mat-dialog-title>Cancel File Download?</h2>
      <mat-dialog-content>
        <p>
          By clicking "Yes" button, you won’t be able to access the download
          link and will need to redo the export process.
        </p>
      </mat-dialog-content>
