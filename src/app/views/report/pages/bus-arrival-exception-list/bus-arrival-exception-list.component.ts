...
export class BusArrivalExceptionListComponent extends DepotBusinessDayReportBase {
  readonly reportName = 'BusArrivalExceptionReport';
  readonly formIdPrefix = 'bus-arrival-exception';
}
