...
router.post('/search', async (req, res) => {
  try {
    const items = await readCollection('operational-bus-list');
    let data = [...items];
...
router.post('/add', async (req, res) => {
  try {
    ...
    await replaceCollection('operational-bus-list', data);
...
router.put('/update', async (req, res) => {
  let items = await readCollection('operational-bus-list');
  ...
  await replaceCollection('operational-bus-list', merged);
