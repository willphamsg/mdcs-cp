...
router.post('/bus-transfer/update', async (req, res) => {
  try {
    ...
    await replaceCollection('bus-transfer-list', merged);
...
router.post('/add', async (req, res) => {
  try {
    ...
    await replaceCollection('bus-transfer-list', data);
...
router.put('/update', async (req, res) => {
  let items = await readCollection('bus-transfer-list');
  const updateItems = req.body;
...
router.post('/bus-operation-status/connected-buses', async (req, res) => {
  try {
    ...
    const allData = await readCollection('connected-buses');
